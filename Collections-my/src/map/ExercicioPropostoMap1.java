...
class Estado {
    ...
    public Estado(String estado, int populacao) {
        this.estado = estado;
    ...
    public String getPopulacao() {
        //Essa variável retorna o tipo int formatado conforme a regra do exercício. Exemplo: População 3.534.165
        NumberFormat n = NumberFormat.getInstance();
        return n.format(populacao);
    }
    ...
    public boolean equals(Object o) {
        ...
        return populacao == estado1.populacao && estado.equals(estado1.estado);
    }
